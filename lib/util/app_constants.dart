...
class AppConstants {
  static const String APP_NAME = 'Ravol Store';
  static const double APP_VERSION = 1.6;

  static const String BASE_URL = 'https://v16.ravolapp.com';
  ...
  // Shared Key
  static const String THEME = 'ravol_store_theme';
  static const String INTRO = 'ravol_store_intro';
  static const String TOKEN = 'ravol_store_token';
  static const String COUNTRY_CODE = 'ravol_store_country_code';
  static const String LANGUAGE_CODE = 'ravol_store_language_code';
  static const String CART_LIST = 'ravol_store_cart_list';
  static const String USER_PASSWORD = 'ravol_store_user_password';
  static const String USER_ADDRESS = 'ravol_store_user_address';
  static const String USER_NUMBER = 'ravol_store_user_number';
  static const String NOTIFICATION = 'ravol_store_notification';
  static const String NOTIFICATION_COUNT = 'ravol_store_notification_count';
  static const String SEARCH_HISTORY = 'ravol_store_search_history';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.arabic, languageName: 'Swahili', countryCode: 'SW', languageCode: 'ar'),
  ];
}
